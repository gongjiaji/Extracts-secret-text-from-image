...
def est_extract():
    ...
    for i in range(1, 4):
        for j in range(1, 4):
            ...
            print('p=', p, ' q=', q, 'bp=', "%.3f" % est_bit_proportion(message_bit_array))
            if est_bit_proportion(message_bit_array) < 0.5:
                a = p
                b = q
    print("The answer is : p=", a, " q=", b)
    message_bit_array = est_extract_bits_from_image(image_byte_array, header_len, a, b)
